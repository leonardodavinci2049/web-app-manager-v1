...
const setSidebarCookie = (value: boolean) => {
  ...
  // Fallback to traditional method (suppressed warning as this is intentional fallback)
  if (typeof document !== "undefined") {
    // biome-ignore lint/suspicious/noDocumentCookie: This is a fallback when Cookie Store API is not available
